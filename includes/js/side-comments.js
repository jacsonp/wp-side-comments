...
require.register("side-comments/js/section.js", function (exports, require, module) {
    ...
    Section.prototype.showComment = function (event) {
        ...
        if( ! target.is('label') &&
        	! target.is('input') &&
        	! target.hasClass('et_pb_ajax_login_button') &&
        	! ( target.hasClass('attachmentLink') || target.parent().hasClass('attachmentLink') ) 
    ...
    Section.prototype.showCommentForm = function (parentID, commentID) {
        ...
        if (this.comments.length > 0) {
            ...
            jQuery(".comment-form-attachment").detach().appendTo(this.$el.find('.comment-box-entry-attachment-' + commentID));
    ...
    Section.prototype.select = function () {
        if (this.isSelected()) {
            ...
            jQuery(".comment-form-attachment").detach().appendTo(this.$el.find('.comment-box-entry-attachment-'));
            jQuery(".delibera_before_fields").hide();
